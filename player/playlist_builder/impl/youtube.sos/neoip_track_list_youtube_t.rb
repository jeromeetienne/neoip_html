...
require 'impl/youtube/youtube.rb'
require 'impl/youtube/youtube_gdata.rb'
...
def self.build(query_arg)
	...
	video_arr	= Youtube_gdata_t.query(query_arg);
	
	puts( "video_arr.length=#{video_arr.length}");
