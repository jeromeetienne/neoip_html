...
trackgen_info_bliptv0	= [
		{	"cmd"	=> "concat",
			"arg"	=> {	"space"	=> "bliptv",
					"desc"	=> {
						"base_uri" => "http://fordmodelsfashion.blip.tv/rss"
						}
				}
		},
...
trackgen_info_youtube3	= [
		{	"cmd"	=> "concat",
			"arg"	=> {	"space"	=> "youtube",
					"desc"	=> {	"type"		=>	"videos",
							"query_param"	=>	{ "vq" => "stock car"	}
						}
				}
		},
		{	"cmd"	=> "select_random_contiguous",
...
trackgen_info	= trackgen_info_bliptv0
