...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\urfastrplayer on
     Windows, /home/user/dev/urfastrplayer on Linux) in a file named
     urfastrplayer@jerome.etienne and copy that file to
